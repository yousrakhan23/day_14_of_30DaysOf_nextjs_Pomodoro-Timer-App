...
export default function PomodoroTimer() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      <Card className="w-full max-w-md p-6 bg-transparent  shadow-2xl rounded-lg">
        <div className="flex flex-col items-center justify-center gap-6">
          <h1 className="text-4xl font-bold text-white">Pomodoro Timer</h1>
          <p className="text-white font-semibold text-center">A timer for the Pomodoro Technique.</p>
